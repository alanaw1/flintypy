...
if __name__ == "__main__":
    test_hamming_distances()
    test_calculate_bin_v_stat()
    test_calculate_real_v_stat()
    test_numba_permute()
    test_numba_permute_dists()
    test_cache_block_permute()
    test_convolution_of_chi2()
    test_ind_cov()
    test_block_cov()
    test_chi2_weights()
    test_ind_large_p()
    test_block_large_p()
    test_ind_large_p_uniform()
    test_in_large_p_large_n_uniform()
    test_ind_large_p_large_n()
    test_block_large_p_large_n()
